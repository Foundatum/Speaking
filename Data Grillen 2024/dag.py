...
class MyGraph:
    ...
    def _get_filtered_queue(self, queue, color):
        return [node for node in queue if node[1]['color'] == color]
...
def main():
    ...
    nodes = [
        ('ex_Cities',{"duration":2,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_Countries',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_DeliveryMethods',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_People',{"duration":3,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_StateProvinces',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_Suppliers',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_BuyingGroups',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_Customers',{"duration":3,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_CustomerCategories',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_Colors',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_PackageTypes',{"duration":1,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_StockItems',{"duration":2,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_Orders',{"duration":5,"color":"red","dep_count":0,"queue":"copy"})
        ,('ex_OrderLines' ,{"duration":7,"color":"red","dep_count":0,"queue":"copy"})
        ,('int_Cities',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_Countries',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_DeliveryMethods',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_People',{"duration":3,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_StateProvinces',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_Suppliers',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_BuyingGroups',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_Customers',{"duration":3,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_CustomerCategories',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_Colors',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_PackageTypes',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_StockItems',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_Orders',{"duration":5,"color":"red","dep_count":0,"queue":"spark"})
        ,('int_OrderLines' ,{"duration":7,"color":"red","dep_count":0,"queue":"spark"})
        ,('prep_dim_customer',{"duration":3,"color":"red","dep_count":0,"queue":"spark"})
        ,('prep_dim_employee',{"duration":1,"color":"red","dep_count":0,"queue":"spark"})
        ,('prep_dim_product',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('prepare_fact_sales',{"duration":5,"color":"red","dep_count":0,"queue":"spark"})
        ,('load_dim_customer',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('load_dim_employee',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('load_dim_product',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('replace_fact_sk',{"duration":2,"color":"red","dep_count":0,"queue":"spark"})
        ,('load_fact',{"duration":3,"color":"red","dep_count":0,"queue":"spark"})
    ]
    edges = [
